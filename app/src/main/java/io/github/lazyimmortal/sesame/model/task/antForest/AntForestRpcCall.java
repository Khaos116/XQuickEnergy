...
public class AntForestRpcCall {
    ...
    public static String queryEnergyRainHome() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryEnergyRainHome", "[{\"source\":\"senlinguangchuangrukou\",\"version\":\""+VERSION+"\"}]");
    }
    ...
    public static String finishTaskopengreen(String taskType, String sceneCode) throws JSONException {
        ...
        params.put("taskType", taskType);
        String args = "[" + params + "]";
        return ApplicationHook.requestString("com.alipay.antieptask.finishTaskopengreen", args);
    }
}