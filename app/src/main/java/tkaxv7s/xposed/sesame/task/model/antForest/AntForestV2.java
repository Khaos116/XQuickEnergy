...
public class AntForestV2 extends ModelTask {
    ...
    public ModelFields setFields() {
        ...
        modelFields.addField(ecoLifeTick = new BooleanModelField("ecoLifeTick", "绿色行动打卡", true));
        modelFields.addField(photoGuangPan = new BooleanModelField("photoGuangPan", "光盘行动", true));
        return modelFields;
    }
